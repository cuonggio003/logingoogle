                ...
                <div class="card-body">
                    <form method="post" action="{{ route('edit.note', $note->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <strong class="text-danger">*</strong>
                            <textarea type="text" value="{{ $note->content }}"
                                class="form-control @error('conten') is-invalid  @enderror" id="content" rows="3"
                        ...
                        <div class="form-group">
                            ...
                            <strong class="text-danger">*</strong>
                            <select class="form-control" name="category" value="{{ $note->type }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <input type="date" class="form-control" name="date" id="date" value="{{ $note->date }}"
                                    required>
                            </div>
                            @error('date')
                                <p class="text-danger">{{ $message }}</p>
